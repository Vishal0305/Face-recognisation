...
# # Making a Face Detection model with VGG16
# 
...
validation_data_dir = 'ImageData/test/'
...
face_recognition = {"[0]": "Tanmay Sharma", 
                    "[1]": "Tanmay's brother"}
face_recognition_n = {"n0": "Tanmay Sharma", 
                      "n1": "Tanmay's brother"}
...
for i in range(0,10):
    input_im = getRandomImage("ImageData/test/")
